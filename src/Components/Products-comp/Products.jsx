  ...
  let ProductData = [
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/Arqitel.webm",
      Background: "#0F1196",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/Cula.mp4",
      Background: "#3B4656",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/Layout-Land.mp4",
      Background: "#0A17BC",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/TTR.webm",
      Background: "#323651",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/Maniv-Compressed.mp4",
      Background: "#24A25E",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/Singularity.webm",
      Background: "#3D1AA6",
      PhoneImgSrc: "",
    },
    {
      ...
      live: true,
      case: true,
      vidSrc: "./src/assets/ProductVideos/like-Magic.webm",
      Background: "#39269E",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/Silvr.webm",
      Background: "#A12800",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: true,
      vidSrc: "./src/assets/ProductVideos/rainfall.webm",
      Background: "#0C13A2",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/Intenseye.webm",
      Background: "#BC2C00",
      PhoneImgSrc: "",
    },
    {
      ...
      live: true,
      case: true,
      vidSrc: "./src/assets/ProductVideos/remind.webm",
      Background: "#1243A2",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: true,
      vidSrc: "./src/assets/ProductVideos/summon.webm",
      Background: "#355560",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: true,
      vidSrc: "./src/assets/ProductVideos/jungle.webm",
      Background: "#111192",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/CandidHealth.webm",
      Background: "#170C91",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: true,
      vidSrc: "./src/assets/ProductVideos/yahoo.webm",
      Background: "#1D013F",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/Yir-2022.webm",
      Background: "#0D009D",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/Yir-2021.webm",
      Background: "#2D2051",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/showcase.mp4",
      Background: "#B06001",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/weglot.webm",
      Background: "#1D3426",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./src/assets/ProductVideos/rocketchat.webm",
      Background: "#A10000",
      PhoneImgSrc:
