  ...
  let ProductData = [
    {
      ...
      live: true,
      case: false,
      vidSrc: "./ProductVideos/Arqitel.webm",
      Background: "#0F1196",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./ProductVideos/Layout-Land.mp4",
      Background: "#0A17BC",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./ProductVideos/Maniv-Compressed.mp4",
      Background: "#24A25E",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./ProductVideos/Singularity.webm",
      Background: "#3D1AA6",
      PhoneImgSrc: "",
    },
    {
      ...
      live: true,
      case: true,
      vidSrc: "./ProductVideos/like-Magic.webm",
      Background: "#39269E",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./ProductVideos/Silvr.webm",
      Background: "#A12800",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: true,
      vidSrc: "./ProductVideos/rainfall.webm",
      Background: "#0C13A2",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./ProductVideos/Intenseye.webm",
      Background: "#BC2C00",
      PhoneImgSrc: "",
    },
    {
      ...
      live: true,
      case: true,
      vidSrc: "./ProductVideos/remind.webm",
      Background: "#1243A2",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: true,
      vidSrc: "./ProductVideos/summon.webm",
      Background: "#355560",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: true,
      vidSrc: "./ProductVideos/jungle.webm",
      Background: "#111192",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./ProductVideos/CandidHealth.webm",
      Background: "#170C91",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: true,
      vidSrc: "./ProductVideos/yahoo.webm",
      Background: "#1D013F",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./ProductVideos/Yir-2022.webm",
      Background: "#0D009D",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./ProductVideos/Yir-2021.webm",
      Background: "#2D2051",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./ProductVideos/showcase.mp4",
      Background: "#B06001",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./ProductVideos/weglot.webm",
      Background: "#1D3426",
      PhoneImgSrc:
    ...
    },
    {
      ...
      live: true,
      case: false,
      vidSrc: "./ProductVideos/rocketchat.webm",
      Background: "#A10000",
      PhoneImgSrc:
        ...
        <div className="wraper-window hidden lg:block w-full h-full absolute top-0 pointer-events-none">
          ...
          >
            {ProductData.map((val, index) => (
              ...
              >
                <video
                  src={`${process.env.PUBLIC_URL}/${val.vidSrc}`}
                  autoPlay
                  loop
                  muted
